                    ...
                    <div class="col-12">
                        ...
                        <div class="card-content collapse show">
                            ...
                            <tbody>
                                    ...
                                    <?php
                                    $quer = mysqli_query($con,"SELECT * from student_regester where sem ='$stud'");
                                    foreach($quer as $que1) 
                                    {
                                        ?>
                                        ...
                                        <td><form action="studentdetailsedit.php" method="post">
                                            <input type="text" name="sent" value="<?php echo $que1['usn']; ?>" hidden><input type="submit" value="Edit" name="submit1" class="btn btn-success form-control round"> </form></td>
                                        </tr>    
                                    <?php
                                    }
                                    ?>
